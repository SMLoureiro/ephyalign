...
class TestDetectStimOnsets:
    ...
    def test_respects_min_interval(self, synthetic_recording, dt):
        ...
        result_large = detect_stim_onsets(synthetic_recording, dt, min_interval_s=10.0)
        result_small = detect_stim_onsets(synthetic_recording, dt, min_interval_s=2.0)
    ...
    def test_threshold_affects_detection(self, synthetic_recording, dt):
        ...
        result_high = detect_stim_onsets(synthetic_recording, dt, threshold_multiplier=20.0)
        result_low = detect_stim_onsets(synthetic_recording, dt, threshold_multiplier=2.0)
